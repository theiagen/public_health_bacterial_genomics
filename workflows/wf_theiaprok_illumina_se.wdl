      ...
      if(defined(taxon_tables)) {
        call terra_tools.export_taxon_tables {
          input:
            ...
            theiaprok_illumina_pe_version = 'null',
            theiaprok_illumina_se_analysis_date = version_capture.date,
            theiaprok_illumina_pe_analysis_date = 'null',
            seq_platform = seq_method,
            num_reads_raw_pairs = 'null',
            ...
            num_reads_clean2 = 'null',
            num_reads_clean_pairs = 'null',
