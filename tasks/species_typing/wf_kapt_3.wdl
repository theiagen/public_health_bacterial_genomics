version 1.0
#import "./task_kleborate.wdl" as kleborate

workflow kapt_test {

  input {
    String samplename = "AC1633"
    File assembly
    #File reference_loci_k
    #File logic_loci_k
    #File reference_loci_oc
  }
  ...
  call kaptive {
      input:
        ...
        #reference_loci_k = reference_loci_k,
        #logic_loci_k = logic_loci_k,
        #reference_loci_oc = reference_loci_oc
    }

  output {
  File? kaptive_output_file_k = kaptive.kaptive_output_file_k
  File? kaptive_output_file_oc = kaptive.kaptive_output_file_oc
  String? kaptive_key_resistance_genes = kaptive.kaptive_k_expected_inside_genes
  String? kaptive_genomic_resistance_mutations = kaptive.kaptive_k_other_outside_genes
  }
}
