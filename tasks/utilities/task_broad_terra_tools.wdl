...
task export_taxon_tables {
  input {
    ...
    String? pbptyper_pbptype_predicted 
    File? pbptyper_pbptype_predicted_tsv 
    File? pbptyper_pbptype_1A_tsv 
    File? pbptyper_pbptype_2B_tsv 
    File? pbptyper_pbptype_2X_tsv 
