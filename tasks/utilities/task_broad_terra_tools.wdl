...
task export_taxon_tables {
  input {
    ...
    String? kaptive_k_match
    String? kaptive_k_expected_inside_genes
    String? kaptive_k_expected_outside_genes
    String? kaptive_k_other_inside_genes
    String? kaptive_k_other_outside_genes
    String? kaptive_oc_match
    String? kaptive_oc_expected_inside_genes
    String? kaptive_oc_expected_outside_genes
    String? kaptive_oc_other_inside_genes
    String? kaptive_oc_other_outside_genes
