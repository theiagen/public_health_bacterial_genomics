...
task export_taxon_tables {
  input {
    ...
    String? kaptive_k_confidence
    String? kaptive_oc_match
    String? kaptive_oc_type
    String? kaptive_oc_confidence
