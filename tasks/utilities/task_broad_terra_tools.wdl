...
task export_taxon_tables {
  input {
    ...
    String gambit_predicted_taxon_threshold
    String gambit_next_taxon
    String gambit_next_taxon_rank
    String gambit_next_taxon_threshold
